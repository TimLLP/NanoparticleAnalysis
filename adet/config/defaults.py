...
_C.MODEL.BLENDMASK.TINY_WEIGHT = [4.0, 0.2]
_C.MODEL.BLENDMASK.NORMAL_WEIGHT = [4.0, 0.2]
_C.MODEL.BLENDMASK.BINARY_TINY_WEIGHT = 0.8
_C.MODEL.BLENDMASK.BINARY_NORMAL_WEIGHT = 0.2

# ---------------------------------------------------------------------------- #
# ModifiedBLENDMASK Options
# ---------------------------------------------------------------------------- #
_C.MODEL.ModifiedBlendMasK = CN()
_C.MODEL.ModifiedBlendMasK.ATTN_SIZE = 14
_C.MODEL.ModifiedBlendMasK.TOP_INTERP = "bilinear"
_C.MODEL.ModifiedBlendMasK.BOTTOM_RESOLUTION = 56
_C.MODEL.ModifiedBlendMasK.POOLER_TYPE = "ROIAlignV2"
_C.MODEL.ModifiedBlendMasK.POOLER_SAMPLING_RATIO = 1
_C.MODEL.ModifiedBlendMasK.POOLER_SCALES = (0.25,)
_C.MODEL.ModifiedBlendMasK.INSTANCE_LOSS_WEIGHT = 1.0
_C.MODEL.ModifiedBlendMasK.VISUALIZE = False
_C.MODEL.ModifiedBlendMasK.VISUALIZE = False
_C.MODEL.ModifiedBlendMasK.TINY_WEIGHT = [4.0, 0.2]
_C.MODEL.ModifiedBlendMasK.NORMAL_WEIGHT = [4.0, 0.2]
_C.MODEL.ModifiedBlendMasK.BINARY_TINY_WEIGHT = 0.8
_C.MODEL.ModifiedBlendMasK.BINARY_NORMAL_WEIGHT = 0.2
