...
def measure_layer(layer, *args):
    ...
    for x in args:
        ...
        ### ops_nothing
        elif type_name in ['BatchNorm2d', 'Dropout2d', 'DropChannel', 'Dropout', 'FrozenBatchNorm2d', 'GroupNorm',"BatchNorm1d", "LayerNorm"]:
            delta_params = get_layer_param(layer)
            ...
            delta_ops = x.numel()
                           ...
                           'NaiveSyncBatchNorm', 'Upsample', 'Sequential',"Softmax","Conv1d"]:
            pass
