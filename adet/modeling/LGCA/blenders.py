...
class Blender(object):
    def __init__(self, cfg):
        ...
        # fmt: off
        self.pooler_resolution = cfg.MODEL.ModifiedBlendMasK.BOTTOM_RESOLUTION
        sampling_ratio         = cfg.MODEL.ModifiedBlendMasK.POOLER_SAMPLING_RATIO
        pooler_type            = cfg.MODEL.ModifiedBlendMasK.POOLER_TYPE
        pooler_scales          = cfg.MODEL.ModifiedBlendMasK.POOLER_SCALES
        self.attn_size         = cfg.MODEL.ModifiedBlendMasK.ATTN_SIZE
        self.top_interp        = cfg.MODEL.ModifiedBlendMasK.TOP_INTERP
