...
from adet.modeling.backbone.dilatedconv.dilatedfpn import Dilated_FPN
...
class PyramidVisionTransformer(Backbone):
    def __init__(self, img_size=256, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        # self.tiny_feature = Tiny_Conv(channel=256)
    ...
    def forward_features(self, x):
        # print("picture_size{}".format(x.shape))
        # tiny_feature = self.tiny_feature(x)
        outs = {}
        B = x.shape[0]
        # stage 1
