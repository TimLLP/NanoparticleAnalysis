...
class LastLevelP6P7(nn.Module):
    """
    This module is used in RetinaNet and FCOSES to generate extra layers, P6 and P7 from
    C5 or P5 feature.
    """
...
class LastLevelP6(nn.Module):
    """
    This module is used in FCOSES to generate extra layers
    """
...
def build_fcoses_resnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
    ...
    top_levels = cfg.MODEL.FCOSES.TOP_LEVELS
    print(in_features)
