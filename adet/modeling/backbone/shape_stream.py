...
from adet.modeling import GatedSpatialConv as gsc
...
class FPN(Backbone):
    ...
    def __init__(
        ...
        self.conv3 = nn.Conv2d(in_channels, 1, kernel_size=1, stride=1)

        self.res1 = BasicBlock(out_channels, out_channels, stride=1)
        self.res2 = BasicBlock(out_channels, out_channels, stride=1)
        self.res3 = BasicBlock(out_channels, out_channels, stride=1)
