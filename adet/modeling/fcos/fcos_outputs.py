...
from adet.modeling.losses.sigmoid_dr_loss import sigmoid_dr_loss_jit
...
def compute_ctrness_targets(reg_targets):
    ...
    left_right = reg_targets[:, [0, 2]]#左上角的点
    top_bottom = reg_targets[:, [1, 3]]#右上角的点
...
class FCOSOutputs(nn.Module):
    ...
    def losses(self, logits_pred, reg_pred, ctrness_pred, locations, gt_instances, top_feats=None):
        ...
        # print(instances.logits_pred.size())
    ...
    def fcos_losses(self, instances):
        ...
        # print("class_target{}".format(class_target))
        # print("logits_pred){}".format(instances.logits_pred))
        ...
        # ) / num_pos_avg
        # print(124)
        class_loss = sigmoid_dr_loss_jit(
            instances.logits_pred,
            class_target,
            pos_inds,
            neg_inds,
    ...
    def forward_for_single_feature_map(
        ...
        for i in range(N):
            ...
            per_candidate_nonzeros = per_candidate_inds.contiguous().nonzero(as_tuple=False)
