...
import cv2
import os
images=glob.glob(r'/home/smile/Usmile/数据集/check_data/synthesis/data_2')
...
masks=glob.glob(r'/home/smile/Usmile/数据集/check_data/synthesis/data_2')
...
for image_name,image_name_abspath in zip(image_names,images):
    ...
    if i>10:
        break
    i+=1
test_image=Image.open('/home/smile/Usmile/数据集/check_data/synthesis/data_2/images/data_2.png')
test_mask1=Image.open(r'/home/smile/Usmile/数据集/check_data/synthesis/data_2/masks/data_2_1.png')
test_mask2=Image.open(r'/home/smile/Usmile/数据集/check_data/synthesis/data_2/masks/data_2_2.png')
